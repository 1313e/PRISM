...
*PRISM* was made by **Ellert van der Velden** (`@1313e`_) as part of a Ph.D under supervision of `Prof. Alan Duffy`_ at `Swinburne University of Technology`_.
It is written in pure `Python 3`_ and `publicly available on GitHub`_.

.. _@1313e: https://github.com/1313e
.. _Prof. Alan Duffy: https://www.alanrduffy.com
