...
The `online docs`_ and `tutorials`_ have several examples explaining the different functionalities of the package.
...
Example usage
-------------
See `online docs`_ or `tutorials`_ for a documented explanation on this example.
